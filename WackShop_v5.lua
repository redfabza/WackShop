...
function Library:NewWindow(config)
    ...
    CollapseBtn.Size     = UDim2.new(0,16,0,40)
    ...
    -- offset X ของปุ่มจากขอบซ้าย Main (เปลี่ยนตาม collapsed state)
    local collapseBtnOffsetX = SideW - 8
    ...
    local function SyncCollapseBtn()
        ...
        CollapseBtn.Position = UDim2.new(
            ...
            0, mp.Y + 46 + (ms.Y - 46)/2 - 20  -- กึ่งกลาง Body ใต้ TitleBar 46px
        )
    end
